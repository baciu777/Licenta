...
class Segmentation(object):
    ...
    def predict_photo_text(self, img):
        ...
        for line in sorted_contours_lines:
            ...
            cv2.drawContours(mask, [line], 0, (255), thickness=cv2.FILLED)
            ...
            for word in sorted_contour_words:
                ...
                word = self.word_image(word, original_image)
    ...
    def dilate_lines(self, image, dilated_words):  # combine 2 images: the middle of the line and the words dilation
    ...
    def horizontal_projections(self, image):
        # threshold the image
        sum_of_rows = []
    ...
    def word_image(self, word, original_image):
        x2, y2, w2, h2 = cv2.boundingRect(word)
        image = [x2, y2, x2 + w2, y2 + h2]
        cv2.rectangle(original_image, (x2, y2), (x2 + w2, y2 + h2), (255, 255, 100), 2)
        return image
